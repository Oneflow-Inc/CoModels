...
from flowvision.models.detection import det_utils
from flowvision.models.detection.anchor_utils import AnchorGenerator
from flowvision.models.detection.transform import GeneralizedRCNNTransform
from flowvision.models.detection.backbone_utils import resnet_fpn_backbone, _validate_trainable_layers
...
from flowvision.models.detection.transform import _resize_boxes,paste_masks_in_image,_resize_keypoints
...
@ModelCreator.register_model
def retinanet_resnext50_32x4d_fpn_(
    pretrained: bool = False,
    progress: bool = True,
    num_classes: Optional[int] = 91,
    pretrained_backbone: bool = True,
