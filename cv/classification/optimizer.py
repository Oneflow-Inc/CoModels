                ...
                [
                    {
                        ...
                        "clip_grad_max_norm": config.TRAIN.CLIP_GRAD,
                        "clip_grad_norm_type": 2.0,
                    },
                    {
                        "params": iter(parameters[1]["params"]),
                        "momentum": config.TRAIN.OPTIMIZER.MOMENTUM,
                        # TODO: OneFlow support for nesterov args in SGD optimizer
                        # nesterov=True,
                        "lr": config.TRAIN.BASE_LR,
                        "weight_decay": parameters[1]["weight_decay"],
                        "clip_grad_max_norm": config.TRAIN.CLIP_GRAD,
                        "clip_grad_norm_type": 2.0,
                    },
                ],
            ...
            optimizer = optim.AdamW(
                [
                    ...
                    },
                    {
                        ...
                        "lr": config.TRAIN.BASE_LR,
                        "weight_decay": config.TRAIN.WEIGHT_DECAY,
                        "clip_grad_max_norm": parameters[1]["weight_decay"],
                        "clip_grad_norm_type": 2.0,
                    }
                ],
            )
